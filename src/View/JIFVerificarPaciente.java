...
public class JIFVerificarPaciente extends javax.swing.JInternalFrame {
    ...
    public void setaCampos(PacienteRaiz paciente) {
        ...
        this.getComboMedicos().setSelectedItem(paciente.getMedico().getNomeMedico());
    ...
    public void enabledCampos(boolean valor){
        ...
        this.getComboMedicos().setEnabled(valor);
    }
    ...
    public boolean validaCampos() {
        ...
        if (this.cbMedicos.getSelectedIndex() == -1) {
            this.mostraMensagem("Informe o medico do paciente.");
            this.cbMedicos.requestFocus();
            return false;
        }
    ...
    private void initComponents() {
        ...
        jTablePacientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "Nome", "Telefone", "CPF", "Médico"
            }
        ) {
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cbMedicos, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jButtonAlterar, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 120, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addContainerGap())))
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
